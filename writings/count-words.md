...
* Ordering: if the frequency of two words is the same, their order in the output doesn't matter. I use a [normalization script](https://github.com/hyblancode/countwords/blob/master/normalize.py) to ensure the output is correct.
...
[**simple.py**](https://github.com/hyblancode/countwords/blob/c66dd01d868aa83dc30a9c95226575df1e5e1c5a/simple.py)
...
[**optimized.py**](https://github.com/hyblancode/countwords/blob/5318b1acdd5bd313039d480af535cf79565c2e62/optimized.py)
...
[**simple.go**](https://github.com/hyblancode/countwords/blob/c66dd01d868aa83dc30a9c95226575df1e5e1c5a/simple.go)
...
In any case, it's fixed now. Thanks to Miguel Angel for [noticing the issue](https://github.com/hyblancode/countwords/pull/81) and simplifying the code.

[**optimized.go**](https://github.com/hyblancode/countwords/blob/8c05595ac632b53d189ce263cf943cae29dc6c14/optimized.go)
...
[**simple.cpp**](https://github.com/hyblancode/countwords/blob/c66dd01d868aa83dc30a9c95226575df1e5e1c5a/simple.cpp)
...
[**simple.c**](https://github.com/hyblancode/countwords/blob/c66dd01d868aa83dc30a9c95226575df1e5e1c5a/simple.c)
...
[**optimized.c**](https://github.com/hyblancode/countwords/blob/c66dd01d868aa83dc30a9c95226575df1e5e1c5a/optimized.c)
...
[**simple.awk**](https://github.com/hyblancode/countwords/blob/c66dd01d868aa83dc30a9c95226575df1e5e1c5a/simple.awk)
...
[**optimized.awk**](https://github.com/hyblancode/countwords/blob/c66dd01d868aa83dc30a9c95226575df1e5e1c5a/optimized.awk)
...
[**simple.fs**](https://github.com/hyblancode/countwords/blob/9d81d13711e56c25068893880a648ac96d0fa92e/simple.fs)
...
[**optimized.fs**](https://github.com/hyblancode/countwords/blob/9d81d13711e56c25068893880a648ac96d0fa92e/optimized.fs)
...
* [A "bonus" version](https://github.com/hyblancode/countwords/blob/8553c8f600c40a4626e966bc7e7e804097e6e2f4/rust/bonus/main.rs) that is similar to the simple version but does Unicode-aware word segmentation and has a few other goodies. Andrew said this is how he'd write it if someone asked for a versatile version.
* [A custom hash table version]((https://github.com/hyblancode/countwords/blob/8553c8f600c40a4626e966bc7e7e804097e6e2f4/rust/optimized-customhashmap/main.rs)). It's an approximate port of my C version, and almost as fast.
* [A trie version](https://github.com/hyblancode/countwords/blob/8553c8f600c40a4626e966bc7e7e804097e6e2f4/rust/optimized-trie/main.rs) that uses a [trie data structure](https://en.wikipedia.org/wiki/Trie) instead of a hash table. Andrew (like me) thought this might be faster, but it turns out to be slightly slower.
...
[**rust/simple/main.rs**](https://github.com/hyblancode/countwords/blob/8553c8f600c40a4626e966bc7e7e804097e6e2f4/rust/simple/main.rs)
...
[**rust/optimized/main.rs**](https://github.com/hyblancode/countwords/blob/8553c8f600c40a4626e966bc7e7e804097e6e2f4/rust/optimized/main.rs)
...
Many readers contributed to the [`hyblancode/countwords`](https://github.com/hyblancode/countwords) repository to add other popular languages -- thank you! (Note that I'm no longer taking new contributions.)
...
* Go: [Miguel Angel](https://github.com/ntrrg) - simplifying the Go optimized version; [Joshua Corbin](https://github.com/jcorbin) - adding a [parallel Go version](https://github.com/hyblancode/countwords/blob/9db2ab6808921e649fc5212c00712e61edf6fa1c/parallel.go) for demonstration
...
Below are the performance numbers of running these programs on my laptop (64-bit Linux with an SSD using these [versions](https://github.com/hyblancode/countwords/blob/master/versions.txt)). I'm running each test five times and taking the minimum time as the result (see [benchmark.py](https://github.com/hyblancode/countwords/blob/master/benchmark.py)). Each run is basically equivalent to the following command:
