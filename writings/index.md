...
* [I/O is no longer the bottleneck](/writings/io-is-no-longer-the-bottleneck/) in 2022, and hasn't been for a while. Disk I/O is fast, and this article provides some numbers. (November)
...
* [Tools I use to build my website](/writings/tools-i-use-to-build-my-website/) describes how I build `hyblan.com` with GitHub Pages, Jekyll, a simple HTML+CSS layout, Sublime Text, and Sublime Merge. (August)
