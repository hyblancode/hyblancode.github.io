...
[Full regex table code on GitHub.](https://github.com/hyblancode/go-routing/blob/master/retable/route.go)
...
[Full regex switch code on GitHub.](https://github.com/hyblancode/go-routing/blob/master/reswitch/route.go)
...
[Full pattern matcher code on GitHub.](https://github.com/hyblancode/go-routing/blob/master/match/route.go)

**Update:** Yuri Vishnevsky sent me an [interesting variant](https://gist.github.com/hyblancode/98b08cf79d0fe659b5700c52667c8742) of this idea on Gophers Slack. In his words, "I decided to inline the pieces, so the match arguments reads as the path does: `match("foo", &bar, "baz")`." I quite like this -- thanks Yuri!
...
[Full split switch code on GitHub.](https://github.com/hyblancode/go-routing/blob/master/split/route.go)
...
[Full ShiftPath code on GitHub.](https://github.com/hyblancode/go-routing/blob/master/shiftpath/route.go)
...
[Full Chi code on GitHub.](https://github.com/hyblancode/go-routing/blob/master/chi/route.go)
...
[Full Gorilla code on GitHub.](https://github.com/hyblancode/go-routing/blob/master/gorilla/route.go)
...
[Full Pat code on GitHub.](https://github.com/hyblancode/go-routing/blob/master/pat/route.go)
